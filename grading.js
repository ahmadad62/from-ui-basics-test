const points =
    [
        {
            id: 1,
            question: 'Use poitioning to fix the header to the top of the page. It should take up 100% of the available space and not cover any of the content below (15 point)',
            grade: 15
        },
        {
            id: 2,
        ...
        {
            id: 4,
            question: 'Give three h3 elements in the html document the same class. Change color of the h3 elements to orange using rbg. The size of the text should be 2em. The text should appear as uppercase.(30 point)',
            grade: 30
        },
        {
            id: 5,
        ...
        {
            id: 8,
            question: 'In the "Link" section, insert a link that redirects the user to an image of your favourite book cover. Make sure that the image opens in a new tab.(10 point)',
            grade: 10
        },
        {
            id: 9,
